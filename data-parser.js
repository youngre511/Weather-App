dataParser = function(weatherData) {
	...
	weatherData.list.forEach(period => {
		...
		let timeAbb = date.toLocaleString("en-US", {hour: 'numeric', hour12: true})
		let cond = defineCondition(period.weather[0].id, period.wind.speed, period.wind.gust, (period.pop*100), period.main.temp)
		let weatherD = {
